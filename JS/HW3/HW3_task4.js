...
function printChart (companyStructure, prefix = "") {
    companyStructure.map(function (level) {
        console.log(prefix  + level.name + " ("+ level.users_count + ")");

        if (level.children) {
        printChart(level.children, prefix + '--');
        }
    });
}
